// Imports
import { ICodexData, ICodexProps, ICodexState } from 'Interfaces';
...
export class CodexComponent extends React.Component<ICodexProps, ICodexState> {
  ...
  private constructor(props: ICodexProps) {
    super(props);
    this.state = {
      dataOpen: -1
    };
  ...
  public componentDidUpdate(prevProps: ICodexProps): void {
    let state: string;
        ...
        <div className="codex__home js-home">
          ...
          <nav>
            <ul className="codex__home--list">
              {this.context.page.codex.map((data: ICodexData, index: number) =>
